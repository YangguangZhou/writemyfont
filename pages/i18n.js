...
const i18n = {
	...
	'zh-TW': {
		...
		// 字表名稱
		glyphListNames: {
			'基礎字': 'Basic Characters',
			'簡體常用字': 'Simplified Common',
			'簡體常用字#1': 'Simplified Common #1',
			'簡體常用字#2': 'Simplified Common #2',
			'簡體常用字#3': 'Simplified Common #3',
			'簡體常用字#4': 'Simplified Common #4',
			'簡體常用字#5': 'Simplified Common #5',
			'簡體常用字#6': 'Simplified Common #6',
			'簡體常用字#7': 'Simplified Common #7',
			'繁體字': 'Traditional Characters',
			'基本包-漢字#1': 'Basic Kanji #1',
			'基本包-漢字#2': 'Basic Kanji #2',
			'基本包-漢字#3': 'Basic Kanji #3',
			'基本包-漢字#4': 'Basic Kanji #4',
			'基本包-漢字#5': 'Basic Kanji #5',
			'基本包-漢字#6': 'Basic Kanji #6',
			'基本包-漢字#7': 'Basic Kanji #7',
			'基本包-漢字#8': 'Basic Kanji #8',
			'基本包-漢字#9': 'Basic Kanji #9',
			'基本包-漢字#10': 'Basic Kanji #10',
			'基本包-漢字#11': 'Basic Kanji #11',
			'基本包-漢字#12': 'Basic Kanji #12',
			'基本包-漢字#13': 'Basic Kanji #13',
			'基本包-漢字#14': 'Basic Kanji #14',
			'基本包-漢字#15': 'Basic Kanji #15',
			'基本包-符號': 'Basic Symbols',
			'本土包-漢字#1': 'Local Kanji #1',
			'本土包-漢字#2': 'Local Kanji #2',
			'本土包-符號': 'Local Symbols',
			'日文包-漢字#1': 'Japanese Kanji #1',
			'日文包-漢字#2': 'Japanese Kanji #2',
			'日文包-符號': 'Japanese Symbols',
			'粵語包-漢字': 'Cantonese Characters',
			'命名包-漢字#1': 'Name Characters #1',
			'命名包-漢字#2': 'Name Characters #2',
			'補充符號包': 'Supplementary Symbols',
			'附表：台文全羅': 'Appendix: Tailo',
			'附表：心經': 'Appendix: Heart Sutra',
			'希臘字母': 'Greek Letters',
			'希臘文': 'Greek'
		}
	},
